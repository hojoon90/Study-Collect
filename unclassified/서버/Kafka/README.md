...
<img src="images/no_group.png" width="50%" height="50%"/>

하나의 토픽을 두개의 컨슈머에서 데이터를 가져가는 경우 아래 그림과 같이 데이터를 가져가게 됨.

<img src="images/consume1.png" width="50%" height="50%"/>

Consumer 1 이 3번까지 데이터를 가져간다. 이 때 offset은 4번을 읽을 위치로 감.

<img src="images/consume2.png" width="50%" height="50%"/>
...
- 컨슈머 인스턴스중 하나가 장애가 나도 나머지 2개의 컨슈머에서 데이터 처리가 가능.
- 이렇게 구성할 경우 하나의 파티션을 하나의 컨슈머가 붙어 데이터 처리가 이루어지므로 속도에서 차이가 나타나게 됨.

<img src="images/ext_consumer.png" width="50%" height="50%"/>
